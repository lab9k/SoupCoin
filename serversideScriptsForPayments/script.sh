...
# geth --exec "loadScript("tmp/checkbalances.js"); jsFunction($1, $2, $3, $4)" attach;
...
function runTransaction {
	...
	geth --exec "loadScript(\"./tmp/checkbalances.js\"); lol(\"$1\",\"$2\",\"$3\",\"$4\")" attach;
} 

function startGeth {

	 $(geth --networkid=4 --datadir=/Users/pieter-janphilips/.rinkeby --cache=512 --ethstats='''yournode:Respect my authoritah!@stats.rinkeby.io''' --bootnodes=enode://a24ac7c5484ef4ed0c5eb2d36620ba4e4aa13b8c84684e1b4aab0cebea2ae45cb4d375b77eab56516d34bfbd3c1a833fc51296ff084b770b94fb9028c4d25ccf@52.169.42.101:30303 --rpc --rpcapi="personal,eth,network" &>/dev/null &disown )  
	 # $(disown)
}
